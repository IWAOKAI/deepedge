...
use deepedge::api::{AppState, list_markets, get_market, get_strikes, get_density, get_surface_health, get_calendar_health, get_walrus_blob, verify_blob, get_edges, get_manager, get_positions, get_ranges, get_summary, get_vault_health, get_cross_venue, run_agent, agent_status, agent_ledger};
...
async fn main() -> anyhow::Result<()> {
    ...
    let app = Router::new()
        ...
        .route("/api/markets/:oracle_id/density", get(get_density))
        ...
        .route("/api/verify", get(verify_blob))
